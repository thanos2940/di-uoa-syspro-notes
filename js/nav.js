...
const topics = [
    ...
    { id: 'topic1', title: 'Unix Basics', path: 'topic1_unix_commands.html', icon: SVG_ICONS.folder },
    { id: 'topic2', title: 'Bash Programming', path: 'topic2_bash.html', icon: SVG_ICONS.terminal },
    { id: 'topic3', title: 'I/O & Signals', path: 'topic3_io_signals.html', icon: SVG_ICONS.radio },
    { id: 'topic4', title: 'Fork & Pipes', path: 'topic4_fork_pipes.html', icon: SVG_ICONS.fork },
    { id: 'topic5', title: 'Sockets & IPC', path: 'topic5_sockets.html', icon: SVG_ICONS.network },
    { id: 'topic6', title: 'Threads', path: 'topic6_threads.html', icon: SVG_ICONS.cpu },
    { id: 'topic7', title: 'System V IPC', path: 'topic7_ipc.html', icon: SVG_ICONS.send },
